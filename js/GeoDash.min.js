...
GeoDash.version = "0.1-dev", GeoDash.noConflict = function() {
    ...
    hoverOnDot: function(t, i, e) {
        ...
        this.x(t.date) >= r && (n -= 55), d3.select(s.el).select(".hoverbox").style("left", n + "px"), 
        d3.select(s.el).select(".hoverbox").style("top", a + "px"), d3.select(s.el).select(".hoverbox").html(o), 
        d3.select(s.el).select(".hoverbox").transition().style("display", "block");
    },
    ...
    update: function(t) {
        ...
        this.yAxis.tickValues([ 0, 1 ]), this.options.drawX && (this.svg.append("g").attr("class", "x axis").attr("transform", "translate(" + -1 * (this.width / 2) + "," + 0 + ")").call(this.xAxis), 
        ...
        var e = this.svg.selectAll(".arc").data(this.pie(t)).enter().append("g").attr("class", "arc");
        if (e.append("path").attr("d", this.arc).style("fill", function(t) {
            ...
            console.log("domain", this.color.domain().slice().reverse());
            var o = d3.select(this.options.legend).append("svg"), n = o.selectAll(".legend-item").data(this.color.domain().slice().reverse()).enter().append("g").attr("class", "legend-item").attr("transform", function(t, i) {
